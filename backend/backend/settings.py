...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-ltx5xg2#elku^b#u!y*pix7u!6#=p)qz=ij1=6si+nm8o7!2qx')
...
SESSION_COOKIE_SAMESITE = 'None' if not DEBUG else 'Lax'  # 'None' for cross-origin
